...
if __name__ == '__main__':
    ...
    parameters ={
        'dir_maps_pickle': f'{root_dir}/Training_validation/Maps/10_maps_10_images/pack3',
        ...
        'out_dir_images': f'{root_dir}/Training_validation/Artificial_images/Generated_from_10_maps/pack3/images',  # output directory of images
        'out_dir_labels': f'{root_dir}/Training_validation/Artificial_images/Generated_from_10_maps/pack3/labels',  # output directory of labels        
