...
if __name__ == '__main__':
    ...
    parameters ={
        'dir_maps_pickle': f'{root_dir}/Training_validation/Maps/10_maps_10_images/pack2',
        'num_maps': 10,  # number of maps to be inserted
        'num_images': 34,  # number of images desired
        ...
        'out_dir_images': f'{root_dir}/Training_validation/Artificial_images/Generated_from_10_maps/pack2/images',  # output directory of images
        'out_dir_labels': f'{root_dir}/Training_validation/Artificial_images/Generated_from_10_maps/pack2/labels',  # output directory of labels        
