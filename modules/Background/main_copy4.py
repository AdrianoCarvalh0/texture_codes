...
if __name__ == '__main__':
    ...
    parameters ={
        'dir_maps_pickle': f'{root_dir}/Training_validation/Maps/5_maps_5_images/pack4',
        ...
        'out_dir_images': f'{root_dir}/Training_validation/Artificial_Images/Generated_from_5_maps/pack4/images',  # output directory of images
        'out_dir_labels': f'{root_dir}/Training_validation/Artificial_Images/Generated_from_5_maps/pack4/labels',  # output directory of labels        
        'min_number_vessels': 30,  # minimum number of vessels
        ...
        'number_cols': 1716,  # maximum number of columns for the Bezier curve
        'number_rows': 1444,  # maximum number of rows for the Bezier curve
