...
if __name__ == '__main__':
    ...
    parameters ={
        'dir_maps_pickle': f'{root_dir}/Training_validation_retina/Maps/80_maps_20_images',  # directory of pickles
        'num_maps': 5,  # number of maps to be inserted
        'num_images': 1, # number of images desired
        ...
        'number_cols': 850,  # maximum number of columns for the Bezier curve
        'number_rows': 850,  # maximum number of rows for the Bezier curve
        'number_points': 25,  # determine the number of random points to be generated
        'min_len_trace': 300,  # minimum distance between the initial and final points
        'max_len_trace': 700,  # maximum distance between the initial and final points
