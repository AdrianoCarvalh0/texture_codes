...
if __name__ == '__main__':
    ...
    parameters ={
        'dir_maps_pickle': f'{root_dir}/Training_validation/Maps/5_maps_5_images/pack5',
        ...
        'out_dir_images': f'{root_dir}/Training_validation/Artificial_Images/Generated_from_5_maps/pack5/images',  # output directory of images
        'out_dir_labels': f'{root_dir}/Training_validation/Artificial_Images/Generated_from_5_maps/pack5/labels',  # output directory of labels        
        ...
        'number_cols': 1616,  # maximum number of columns for the Bezier curve
