...
if __name__ == '__main__':
    # Path to the master's project directory
    ...
    for i in range(tam):  
        ...
        #testando
        #intensity_cols_values_all, _ = vs.return_all_instisitys_normal(vessel_map)

        # Attempt to plot the difference between the standard deviation with the normalized column
        #vs.plot_fill_means_std_dev_normal_all(intensity_cols_values_all[0])
