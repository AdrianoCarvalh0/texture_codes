...
from  Utils import functions  # Importing functions from the specified module
...
if __name__ == "__main__":
    ...
    bezier_paths = f'{root_dir}/Artificial_Lines/bezier_traces_tests/'
    ...
    for i in range(500):
        ...
        functions.write_dict_to_file(data_dict, f'{bezier_paths}/img_savedata_{i}.json')
        array_curves.append(curve)
